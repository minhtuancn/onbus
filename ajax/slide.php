    ...
    <div id="slider1_container" style="position: relative; width: 700px; height: 500px; background-color: #DCDCDC; overflow: hidden; ">
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            <div style="filter: alpha(opacity=70); opacity:0.7; position: absolute; display: block;
                background-color: #DCDCDC; top: 0px; left: 0px;width: 100%;height:100%;">
            </div>
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 700px; height: 500px;
            ...
            ?>
            <div>
                <a u=image href="javascript:;"><img src="<?php echo $row['image_url']; ?>" /></a>
            </div>
            <?php } } ?>
        </div>
        ...
        <style>
            ...
            */
            .jssorb13 div, .jssorb13 div:hover, .jssorb13 .av {
                background: url(<?php echo STATIC_URL; ?>/images/b13.png) no-repeat;
                overflow: hidden;
                cursor: pointer;
            }
