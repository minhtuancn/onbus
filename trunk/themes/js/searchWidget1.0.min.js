...
function initSearchTicketWidget() {
    ...
    $('input[data-ticket="type-1"]').parent().addClass("selected");
    $('input[data-ticket="type-2"]').parent().removeClass("selected");
};
$(function(){
          ...
          if(vend > 0){
              if(dstart !=''){
                   ...
                   if(type==2){
                        if(dend != ''){
                            url+= "&dend=" + dend;
                            strSubmit+=' den ngay '+ dend;
                        }else{
                            $('#returnDate').focus();return false;                            
                        }
                   }
                   strSubmit = tripunicode(strSubmit) + "-" +type+ "-" + vstart+"t"+vend;
                   var car = $("#car").val();
                   if(car > 0){
                        url+= "&car=" + car;
                        strSubmit +="l"+car;                   
