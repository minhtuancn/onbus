...
$list = $model->getListImageByNhaxe($nhaxe_id, $offset, LIMIT);
...
<div class="row">
    <div class="col-md-12">
    <button class="btn btn-primary btn-sm right" onclick="location.href='index.php?mod=nhaxe&act=form&nhaxe_id=<?php echo $nhaxe_id; ?>'">Chi tiết nhà xe</button>        
         <div class="box-header">
                <h3 class="box-title">Danh sách hình ảnh nhà xe : <?php echo $detailNhaxe['nhaxe_name_vi']; ?></h3>
            </div><!-- /.box-header -->
        <div class="box">
