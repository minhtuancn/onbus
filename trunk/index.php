        	...
        	<div class="box-sear-ticket">
            	<div class="wrap">
                    ...
                    <div class="left item-search">
						...
						<select class="form-control input-sm left" name="car">
							<option value="0">--Tất cả--</option>
							<?php if(!empty($arrNhaXe['data'])){ 
                            foreach ($arrNhaXe['data'] as $nhaxe) {
                                ?>
                                <option value="<?php echo $nhaxe['nhaxe_id']; ?>"><?php echo $nhaxe['nhaxe_name_vi']; ?></option>                                   
                                <?php
                                }
                            }
                        ?>
					...
					<div class="right item-search">
                        ...
                        <input id="departDate" type="text" class="input-txt date form-control" placeholder="Chọn ngày đi" accesskey="3" tabindex="3" name="date" />

                    </div>
                    <div class="btn-search-ticket">
	                    <button type="submit" class="btn btn-warning right btn-blue">Tìm vé xe</button>
                    ...
                    <ul>
                        <?php if(!empty($arrNhaXeUyTin['data'])){ 
                            foreach ($arrNhaXeUyTin['data'] as $uytin) {
                                ?>
                                <li><a href="#"><?php echo $uytin['nhaxe_name_vi']; ?></a></li>        
                                <?php
                                }
                            }
                        ?>
