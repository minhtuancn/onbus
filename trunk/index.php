...
$str = str_replace("{nhapmakhuyenmai}" , nhapmakhuyenmai , $str);
$str = str_replace("{chonphuongthuc}" , chonphuongthuc , $str);  
$str = str_replace("{whenchoosingthis}" , whenchoosingthis , $str);
$str = str_replace("{thequocte}" , thequocte , $str); 
$str = str_replace("{thenoidia}" , thenoidia , $str);
$str = str_replace("{thanhtoankhinhanve}" , thanhtoankhinhanve , $str);
$str = str_replace("{youpaycash}" , youpaycash , $str);
$str = str_replace("{whichevermethod}" , whichevermethod , $str);  
$str = str_replace("{youmustclick}" , youmustclick , $str);
$str = str_replace("{chonsoluongve}" , chonsoluongve , $str);
$str = str_replace("{datve}" , datve , $str);  
$str = str_replace("{chonvechieuconlai}" , chonvechieuconlai , $str);
$str = str_replace("{chongiokhoihanh}" , chongiokhoihanh , $str);
$str = str_replace("{errortime}" , errortime , $str);
$str = str_replace("{tong}" , tong , $str);
$str = str_replace("{dongythanhtoan}" , dongythanhtoan , $str);
echo $str;
?>