...
if(!isset($_GET['e'])){
    ...
    $time = time();
	$sql = "INSERT INTO orders (order_id,order_code,total_amount,total_price,fullname,phone,email,status,creation_time,method_id)
	VALUES (NULL,'$order_code',$amount,$total,'$fullname','$phone','$email',2,$time,1)";
