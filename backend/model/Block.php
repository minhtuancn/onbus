...
class Block extends Db {
    ...
    function insertBlock() {
        ...
        $sql = "INSERT INTO blocks VALUES(NULL,'$block_name','$block_content_vi','$block_content_en')";								
    ...
    function updateBlock($block_id) {
        ...
        $update_time = time(); 
         ...
         $sql = "UPDATE blocks
                SET block_content_vi = '$block_content_vi',block_content_en = '$block_content_en'				
