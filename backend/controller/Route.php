...
if($route_id > 0) {	
	...
	$model->updateRoute($route_id,$route_name_vi,$route_name_en,$route_name_safe_vi,$route_name_safe_en,$hot,$description,$tinh_id_start,$tinh_id_end,$distance,$duration);

	header('location:'.$url);

}else{

	$model->insertRoute($route_name_vi,$route_name_en,$route_name_safe_vi,$route_name_safe_en,$hot,$description,$tinh_id_start,$tinh_id_end,$distance,$duration);
